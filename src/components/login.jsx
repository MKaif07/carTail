...
const LoginSchema = Yup.object().shape({
  ...
  password: Yup.string()
    .required("Required")
    .min(5, "Password must have atleast 8 characters"),
});
...
function Login() {
  ...
  return (
    <>
      {/* {token ? JSON.stringify(token.token) : "no token"} */}
      {token && <Navigate to="/car" replace={true} />}
      <div className="bg-gray-400 h-screen overflow-hidden flex items-center justify-center">
        <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
          ...
          <Formik
            ...
            // onSubmit={(values) => console.log(values)} //handleSubmit(e, values)}
              ...
              <Form className="p-12 md:p-24">
                <div className="flex items-center text-lg mb-6 md:mb-8">
                  ...
                  <div className="text-red-600 w-full">
                    <Field
                      name="email"
                      className="text-black bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full"
                    />
