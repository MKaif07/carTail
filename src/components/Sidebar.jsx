...
const filters = [
  {
    ...
    options: [
      ...
      { value: "maruti", label: "Maruti", checked: false },
  ...
  return (
    <div className="bg-white w-full  m-0 p-0">
      <div>
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    {filters.map((section) => (
                      <Disclosure
                        as="div"
                        key={section.id}
                        className=" mx-auto border-t border-gray-200 px-6 py-6"
                      >
                        {({ open }) => (
                          <>
        ...
        <main className="mx-4 max-w-full px-1 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ">
              {/* Filters */}
              <form className="hidden grid-flow-col lg:block">
                <h1 className="text-3xl">Budget</h1>
                <RangeSlider />
                {filters.map((section) => (
                  <Disclosure
              ...
              {/* Product grid */}
              <div className="col-span-3 flex flex-row flex-wrap justify-start basis-4 ">
                {children}
              </div>
            </div>
          </section>
